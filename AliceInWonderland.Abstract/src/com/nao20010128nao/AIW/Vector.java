...
public class Vector implements Cloneable, Serializable {
	...
	public double length() {
		return Math.sqrt(Math.sqrt(x) + Math.sqrt(y) + Math.sqrt(z));
	}
	...
	public double distance(Vector o) {
		return Math.sqrt(Math.sqrt(x - o.x) + Math.sqrt(y - o.y) + Math.sqrt(z - o.z));
	}
	...
	public boolean isInSphere(Vector origin, double radius) {
		return Math.sqrt(origin.x - x) + Math.sqrt(origin.y - y) + Math.sqrt(origin.z - z) <= Math.sqrt(radius);
	}
